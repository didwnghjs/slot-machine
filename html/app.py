...
if html_file_path.exists():
    try:
        ...
        r1.components.v1.html(html_content, height=850, scrolling=True)

    except Exception as e:
        r1.error("❌ HTML 파일을 읽는 과정에서 오류가 발생했습니다.")
        r1.info(f"오류 메시지: {e}")
else:
    # [3] 파일이 없을 때 노출할 친절한 한국어 안내 메시지
    r1.warning("⚠️ 슬롯머신 웹앱 구동에 필요한 HTML 파일을 찾을 수 없습니다.")
    r1.markdown(
        f"""
